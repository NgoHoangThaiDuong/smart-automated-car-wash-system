...
<head>
    ...
    <title>Edit Promotion - Smart Car Wash</title>
            ...
            <div class="promo-form-grid">
                ...
                <div class="form-group">
                    ...
                    <select class="promo-form-select" id="targetTierId" name="targetTierId">
                        <option value="" ${empty promotion.targetTierId ? 'selected' : ''}>
                            All Customers
                        </option>
                        <option value="1" ${promotion.targetTierId == 1 ? 'selected' : ''}>
                            Member
                        </option>
                        <option value="2" ${promotion.targetTierId == 2 ? 'selected' : ''}>
                            Silver
                        </option>
                        <option value="3" ${promotion.targetTierId == 3 ? 'selected' : ''}>
                            Gold
                        </option>
                        <option value="4" ${promotion.targetTierId == 4 ? 'selected' : ''}>
                            Platinum
                        </option>
                    </select>
                </div>
