        ...
        <div class="admin-container">
            ...
            <div class="page-header-container">
                ...
                <div class="header-action-row">
                    ...
                    <div>
                        <a href="<c:url value='/admin/customers'/>" class="btn-admin-secondary"
                ...
                <form action="<c:url value='/admin/customers'/>" method="GET" style="margin: 0;">
                    <div class="filter-form-grid">
                        ...
                        <div class="search-input-wrapper">
                            ...
                            <input name="search" class="search-input-field" placeholder="Search" type="text"
                        ...
                        <select name="sortBy" class="filter-select-field">
                            <option value="name_asc" <c:if test="${empty sortBy or sortBy eq 'name_asc'}">
                                    selected</c:if>>Name (A-Z)</option>
                            <option value="name_desc" <c:if test="${sortBy eq 'name_desc'}">selected</c:if>
                                    >Name (Z-A)</option>
                                <option value="spent_desc" <c:if test="${sortBy eq 'spent_desc'}">selected
                                    </c:if>>Total Spent (High -> Low)</option>
                            <option value="spent_asc" <c:if test="${sortBy eq 'spent_asc'}">selected</c:if>
                                    >Total Spent (Low -> High)</option>
                                <option value="washes_desc" <c:if test="${sortBy eq 'washes_desc'}">selected
                                    </c:if>>Total Washes (High -> Low)</option>
                            <option value="washes_asc" <c:if test="${sortBy eq 'washes_asc'}">selected
                                    </c:if>>Total Washes (Low -> High)</option>
                            <option value="points_desc" <c:if test="${sortBy eq 'points_desc'}">selected
                                    </c:if>>Loyalty Points (High -> Low)</option>
                            <option value="points_asc" <c:if test="${sortBy eq 'points_asc'}">selected
                                    </c:if>>Loyalty Points (Low -> High)</option>
                        </select>

                        <!-- Filter Submit -->
                        <button type="submit" class="btn-submit-filter">
                            <span class="material-symbols-outlined" style="font-size: 1.15rem;">tune</span>
                            Filter
                        </button>
                    </div>
                </form>
                                ...
                                <c:when test="${not empty customers}">
                                    <c:forEach var="u" items="${customers}">
                                        <tr>
                                            ...
                                            <!-- Points -->
                                            <td class="td-points">
                                                <fmt:formatNumber value="${u.pointsBalance}" type="number"
                                                                  groupingUsed="true" /> pts
                                            </td>

                                            <!-- Spent -->
                                            <td class="td-spent">
                                                <fmt:formatNumber value="${u.lifetimeSpent}" type="number"
                                                                  groupingUsed="true" /> ₫
                                            </td>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="actions-cell-group"
                                                    ...
                                                    <a href="<c:url value='/admin/customers/detail?id=${u.id}'/>"
                                                       class="btn-detail-icon" title="View Detail">
                                        ...
                                        <c:when test="${currentPage > 1}">
                                            <c:url value="/admin/customers" var="prevUrl">
                                                ...
                                                <c:if test="${not empty selectedTierId}">
                                                    <c:param name="tierId" value="${selectedTierId}" />
                                                </c:if>
            ...
            <div class="rules-card">
                ...
                <div>
                    ...
                    <p class="rules-desc">Membership levels are calculated automatically using total
                        completed washes or cumulative customer billing totals.</p>
