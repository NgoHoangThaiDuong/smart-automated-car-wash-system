                                    ...
                                    <div class="success-screen">
                                        ...
                                        <div class="receipt-table">
                                            ...
                                            <div class="receipt-row">
                                                ...
                                                <span class="receipt-value">${detail.vehicleBrand}
                                                    ${detail.vehicleModel} (${detail.licensePlate})</span>
                                            </div>
                                            <div class="receipt-row">
                                            ...
                                            <div class="receipt-row">
                                                ...
                                                <span class="receipt-value">
                                                    <c:choose>
                                                        <c:when test="${payment.paymentMethod eq 'CASH'}">Tiền mặt tại
                                                            quầy</c:when>
                                                        <c:when test="${payment.paymentMethod eq 'BANK_TRANSFER'}">
                                                            Chuyển khoản Banking</c:when>
                                            ...
                                            <div class="receipt-row receipt-total">
                                                ...
                                                <span class="receipt-value">
                                                    <fmt:formatNumber value="${detail.amount}" type="number"
                                                        groupingUsed="true" /> đ
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="action-buttons">
                                            <a href="${pageContext.request.contextPath}/dashboard"
                                                class="btn btn-primary">Bảng Điều Khiển</a>
                                            <a href="${pageContext.request.contextPath}/booking"
                                                class="btn btn-secondary">Xem Lịch Đặt</a>
                                        </div>
                                    </div>
                                </div>
                            </c:when>
                                ...
                                <div class="payment-card">
                                    ...
                                    <div class="info-group">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <span class="info-value">${detail.vehicleBrand}
                                                ${detail.vehicleModel}</span>
                                        ...
                                        <div class="method-options">
                                            <label class="method-card selected" id="label-cash">
                                                ...
                                                <span class="method-text">
                                                    ...
                                                    <span class="method-desc">Thanh toán trực tiếp sau khi rửa xe
                                                        xong</span>
                                                </span>
                                            </label>
